![Outbound GenVoice Banner](./resources/banner.png)
...
- Overall Performance: Even though the time it takes to get the first part of Open AI's response can vary depending on your location, the Outbound-GenVoice system as a whole is built to streamline the speech to speech process with a big emphasis on latency optimisation. This means that, despite the extra steps involved in delivering a realistic human-like outbound call, the system is able to provide responses in as little as ~1.5 seconds ([Speech-To-Speech Latency In MENA](./resources/images/Agent-On-Call-Response-Latency.png))

## 🎨 Streamlit Web Interface

A professional web interface is now available for easy demo and testing!
...
- 🚀 One-click demo scenarios (MRI, CT Scan, Surgery)
- 📊 Call history viewer with status tracking
- 📋 Real-time server logs
- 💡 API examples and documentation
- ✨ Beautiful, professional interface for presentations
...
Before setting up the project, you'll need accounts and API keys for the following services:

### Required Services

| Service                       | Purpose                                 | Get API Key                                                                                        |
| ----------------------------- | --------------------------------------- | -------------------------------------------------------------------------------------------------- |
| **Twilio**                    | Phone call management (outbound calls)  | [twilio.com/console](https://www.twilio.com/console)                                               |
| **Deepgram**                  | Speech-to-Text (STT)                    | [console.deepgram.com](https://console.deepgram.com)                                               |
| **ElevenLabs**                | Text-to-Speech (TTS)                    | [elevenlabs.io](https://elevenlabs.io)                                                             |
| **AWS Bedrock** or **OpenAI** | LLM for conversation                    | [AWS Console](https://console.aws.amazon.com) / [platform.openai.com](https://platform.openai.com) |
...
LLM_PROVIDER=bedrock  # Options: 'bedrock' or 'openai'
...
# Ngrok Configuration (required for Twilio webhooks)
...
```bash
ngrok http <HTTP_SERVER_PORT>
```

### 4) Set up Environment Variables:

Create your `.env` file with the variables listed in the Prerequisites section above.
...
[
  ...
  {
    "key": "Who are you?",
    "value": "I'm Myra, the recruitment director at Escade Networks."
  },
  {
    "key": "Why are you calling?",
    "value": "I'm calling to discuss your application for one of our job openings..."
  }
]
```
